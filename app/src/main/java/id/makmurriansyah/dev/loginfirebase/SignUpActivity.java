                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(SignUpActivity.this, new OnCompleteListener() {
                            ...
                            public void onComplete(@NonNull Task task) {
                                Toast.makeText(SignUpActivity.this, "Berhasil Mendaftar" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    startActivity(new Intent(SignUpActivity.this, MenuUtama.class));
                                    finish();
                                }
                            }
                        });
